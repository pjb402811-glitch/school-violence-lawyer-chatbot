    ...
    if api_key and api_key.strip():
        try:
            ...
            system_prompt = (
                ...
                "★ [판례 하이퍼링크 조립 극비 수칙] 판례 링크를 조립할 때는 절대 URL 내부에 여는 괄호 '(' 나 닫는 괄호 ')'가 포함되지 않도록 순수한 사건번호로만 주소를 빌드하십시오. 잘못된 예: `https://www.law.go.kr/판례/(2013다27581)`. 올바른 예: `https://www.law.go.kr/판례/2013다27581`.\n"
                "또한, 사용자가 국가법령정보센터 검색창에 직접 사건번호를 입력해 100% 확실하고 오차 없이 판례를 찾을 수 있도록, 모든 판례 하이퍼링크 바로 뒤에는 반드시 괄호를 쳐서 검색창 안내 문구를 함께 덧붙여 출력하십시오. 예: `[대법원 2015. 9. 10. 선고 2013다27581 판결](https://www.law.go.kr/판례/2013다27581) (국가법령정보센터 검색창에 '2013다27581'을 입력하여 즉시 찾으실 수 있습니다.)`\n"
